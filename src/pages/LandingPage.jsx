    ...
    <div className="landing" ref={root}>
      ...
      <section className="landing-hero" id="top">
        ...
        <div className="hero-content">
          ...
          <h1 className="hero-title">
            <span className="line">KADRI</span>
            <span className="line hero-title__serif">holds the work</span>
            <span className="line">behind the frame.</span>
          </h1>
        ...
        <div className="hero-orbit" aria-hidden="true">
          ...
          <div className="orbit-core"><span>LIVE</span><strong>{String(inMotion).padStart(2, '0')}</strong><small>projects in motion</small></div>
      ...
      <section className="landing-section engine" id="engine">
        <div className="section-intro">
          <span className="eyebrow">01 / THE ENGINE</span>
          <h2>Every project has a pulse.</h2>
          <p>KADRI keeps the practical mess visible without turning creative work into spreadsheet theatre.</p>
        </div>
        <div className="engine-frame">
          <div className="engine-top"><span>PRODUCTION ENGINE / LIVE DEMO</span><span className="live-dot"><i /> all systems nominal</span></div>
          <div className="engine-grid">
            <div className="engine-stat"><span>INCOMING</span><strong>{String(incoming).padStart(2, '0')}</strong><small>new briefs waiting</small></div>
            <div className="engine-stat engine-stat--hero"><span>IN MOTION</span><strong>{String(inMotion).padStart(2, '0')}</strong><small>active productions</small><div className="sparkline"><i /><i /><i /><i /><i /><i /><i /></div></div>
            <div className="engine-stat"><span>REVIEW</span><strong>{String(inReview).padStart(2, '0')}</strong><small>versions with clients</small></div>
      ...
      <section className="landing-section review-showcase" id="review">
        <div className="review-showcase__copy">
        ...
        <div className="review-monitor">
          ...
          <video muted autoPlay loop playsInline src="/media/kadri-review.mp4" poster="/media/kadri-review-poster.jpg" />
          <div className="monitor-comment"><span>00:18</span><p>“I would keep the silence here.”</p></div>
        </div>
      </section>
      ...
      <section className="landing-final">
        ...
        <Link to={enterTo} className="giant-enter"><span>ENTER DEMO</span><Command size={34} /></Link>
        <footer><span>Tbilisi, Georgia</span><span>Interactive product demo</span><span>2026</span></footer>
      </section>
    </div>
  );
}
